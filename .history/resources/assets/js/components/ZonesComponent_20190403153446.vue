          ...
          <form @submit.prevent="addZone">
            <div class="modal-body">
              <div class="form-group">
                <input type="text" class="form-control" placeholder="Zone Name" required>
              </div>
              <div class="form-group">
                <input type="number" class="form-control" placeholder="Rate(Naira)" required>
              </div>
            </div>
            <div class="modal-footer">
              <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
              <button type="button" class="btn btn-primary">
                <i class="fa fa-spinner fa-spin" v-show=></i> Submit
              </button>
            </div>
          </form>
        </div>
