            ...
            <div class="modal-body">
              ...
              <div class="form-group" v-for="row in rowCount">
                <input
                  ...
                  v-model="attribute.name"
                >
                <button v-if="row.length === 1" class="btn btn-sm btn-primary" type="button" @click.stop="addRow">+</button>
                <button v-else class="btn btn-sm btn-danger" type="button" @click.stop="remRow">-</button>
              </div>
            </div>
