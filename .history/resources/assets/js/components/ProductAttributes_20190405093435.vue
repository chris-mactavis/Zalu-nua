            ...
            <div class="modal-body">
              ...
              <div class="form-group" v-for="row in rowCount">
                <input
                  ...
                  v-model="attribute.name"
                >
                <button v-if="row === 1" class="btn btn-sm btn-primary" type="button" @click.stop="addRow">+</button>
                <button v-else="row === 1" class="btn btn-sm btn-primary" type="button" @click.stop="addRow">+</button>
              </div>
            </div>
