  ...
  <div class="white-box">
    ...
    <div class="row">
      ...
      <div class="col-3 other-buttons">
        ...
        <button id="select-all" class="btn btn-primary select-all" @click="selectAll">Select All</button>
      ...
      Array.from(document.getElementsByClassName("zone-selector-2")).forEach(
        x => {
          if (x.checked) {
            ...
            this.markSelectedStates = this.markSelectedStates.filter(x => x != state);
