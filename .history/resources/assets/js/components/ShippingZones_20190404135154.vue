      ...
      <div class="col-md-12">
        ...
        <div class="col-sm-4">
          <div class="zone-box">
            ...
            <button id="selectAll" class="btn btn-sm btn-primary select-all" @click="selectAll">Select All</button>
            <button
              id="selectAll"
        ...
        <div class="col-sm-4">
          ...
          :disabled="markSelectedStates"
        >Add to Zone</button>
        <button id="select-all" class="btn btn-sm btn-primary sel-all" @click="selectAllItems">Select All</button>
        <button id="deleteAll" @click="deleteSelected" class="btn btn-sm btn-primary delete-all">Delete</button>
        </div>
      </div>
    </div>
...
export default {
  ...
  methods: {
    ...
    selectAllItems() {
      ...
      this.markSelectedStates = this.markSelectedStates.map(x => {
        let rObj = {};
        rObj = x.state_name;
        return rObj;
      });
