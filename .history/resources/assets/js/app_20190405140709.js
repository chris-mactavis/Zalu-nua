...
$('#add-attribute-btn').on('click', function (evt) {
    ...
    $single_attribute = `<div id="single-attribute">
              ...
              <div class="form-group">
                ...
                <select name="product_attributes_[]" multiple required class="form-control input-lg" id="attribute-select-${(iterate + 1)}">
              ...
              <div class="form-group">
                ...
                <input type="file" name="var_image_[]" class="form-control input-lg" required />
              </div>
            </div>`
