                ...
                <div class="col-md-6">
                    <div class="checkout_sidebar">
                        ...
                        <form action="{{ route('checkout.docheckout') }}" method="post">
                            ...
                            <div class="form-group">
                                <div>
                                    <p class="label form_label" style="color:black">Add special instructions for your order.</p>
                                    <input type="text" class="form-control" placeholder="Add special instructions for your order">
                                </div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <h5 id="total-fee">&#8358;<span>{{ $display_total }}</spa></h5>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
