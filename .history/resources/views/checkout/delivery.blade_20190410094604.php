                        ...
                        <form action="{{ route('checkout.docheckout') }}" method="post">
                            ...
                            <div class="hidden_form" id="hidden_form">
                                <div class="form-group">
                                    ...
                                    <input id="new_address" type="text" class="form-control" name="new_address" required>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="city" type="text" class="form-control" name="city" autocomplete="off" required>
                                </div>
