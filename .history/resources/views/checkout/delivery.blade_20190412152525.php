                ...
                <div class="col-md-6">
                    <div class="checkout_sidebar">
                        ...
                        <form action="{{ route('checkout.docheckout') }}" method="post">
                            ...
                            <div class="form-group">
                                <div>
                                    <p class="form_label">Add special instructions for your order.</p>
                                    <input type="text" namfoe="instruction" class="form-control" placeholder="Add special instructions for your order">
                                </div>
