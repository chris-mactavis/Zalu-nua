      ...
      <form>
        <div class="modal-body">
          <div class="form-group">
            ...
            <select name="product_attributes" multiple class="form-control input-lg" id="attribute-select">
        ...
        <div class="modal-footer">
          ...
          <button type="submit" class="btn btn-primary" id="add-attribute-submit">
            OK
          </button>
        </div>
      </form>
