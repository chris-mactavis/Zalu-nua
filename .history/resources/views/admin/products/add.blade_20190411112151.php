        ...
        <div class="white-box">
          ...
          <form action="{{ route('admin.products.store') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group" id="prod-attributes">
              <h6>Attributes</h6>
              <select name="selected_attributes[]" id="attributes" class="form-control select2" required multiple>
                <option value="">Please select at least one attribute</option>
                @foreach ($product_options as $option)
                <option value="{{$option->id}}">{{$option->option}}</option>
                @endforeach
              </select>
              <select name="selected_attributes[]" class="form-control select2" required multiple>
                <option value="">Please select at least one attribute</option>
                @foreach ($product_options as $option)
                <option value="{{$option->id}}">{{$option->option}}</option>
                @endforeach
            ...
            {{-- <div id="insert-here">
              <div id="single-attribute">
                ...
                <div class="form-group">
                  ...
                  <input type="file" name="var_image_1[]" class="form-control input-lg" required />
                </div>
              </div>
            </div>
