        ...
        <div class="white-box">
          ...
          <form action="{{ route('admin.products.store') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
              ...
              <select name="product_type" id="product_type" class="form-control input-lg" required>
           ...
           <div class="variations">
              ...
              <input type="file" name="var_image" class="form-control input-lg {{ $errors->has('var_image') ? ' is-invalid' : '' }}" required />
          ...
          <div class="button btn btn-sm btn-default">Add Attribute</div>
