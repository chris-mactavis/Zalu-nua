      ...
      <div class="col-md-12">
        <div class="white-box">
          ...
          <form action="{{ route('admin.products.store') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group"><label for="attributes">Attributes</label><select name="selected_attributes" id="attributes" class="form-control"><option value="">Please select </option></select></div>
