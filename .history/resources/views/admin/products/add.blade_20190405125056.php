      ...
      <form>
        <div class="modal-body">
          <div class="form-group">
            ...
            <select name="product_attributes" multiple req class="form-control input-lg" id="attribute-select">
          ...
          <div class="form-group">
            ...
            <input type="file" name="var_image" id="var_image" class="form-control input-lg {{ $errors->has('var_image') ? ' is-invalid' : '' }}" required />
            @if($errors->has('var_image'))
            <span class="invalid-feedback red">
              <strong>{{ $errors->first('var_image') }}</strong>
            </span>
            @endif
          </div>
        </div>
        <div class="modal-footer">
          ...
          <button type="button" class="btn btn-primary" id="add-attribute-submit">
            OK
          </button>
        </div>
      </form>
