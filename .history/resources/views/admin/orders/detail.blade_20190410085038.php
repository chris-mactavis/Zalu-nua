                  ...
                  <div class="table-responsive">
                      <table class="table table-striped">
                        ...
                        <tbody>
                          ...
                          <tr>
                            @php
                            $userinfo = App\UserInfo::with('lga')-find($order->first()->userinfo_id);
                            @endphp
                            <td>Address</td>
                            <td>{{$userinfo->address}},
                              <br> {{$userinfo->city}}, {{$userinfo->country}}
                            </td>
                          </tr>
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-8">
                            <div class="ordered_itm_txt">
                              ...
                              <p><b>Variants: </b> <span class="badge badge-primary">{{$product->variants}}</span></p>
