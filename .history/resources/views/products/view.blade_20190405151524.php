			...
			<div class="col-md-6">
				<div class="detail_img">
	                ...
	                <div id="slider" class="ubislider left">
						...
						<li class="gal"> 
	                    		<a> 
	                    			<img class="product-v-img" src="/{{ $attribute->image }}" data-variants="{{$product->product_attributes[$iterate++]->product_attributes}}" data-variant_id="{{$product->product_attributes[0]}}"> 
	                    		</a> 
	                    	</li>
