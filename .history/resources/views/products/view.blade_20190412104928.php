					...
					<form action="{{ route('cart.add') }}" method="post" style="width:100%" class="add-to-cart-form">
						...
						<p>
							...
							<div class="form-group col-12">
								...
								<input type="radio" name="variant_{{$variant['variant_name']}}" class="product-attribute-option-input" id="v-{{$item}}" value="{{App\ProductAttributeOption::find($item)->option}}" required>
								<label for="v-{{$item}}" class="product-attribute-option">
									{{App\ProductAttributeOption::find($item)->option}}
								</label>
								@endforeach
							</div>
							@endforeach
						...
						<div class="product_btns">
							<div class="product_btn_itm">
								...
								<button type="submit" class="add_to_cart" id="add-to-cartt">Add to Cart</button>
							</div>
							<div class="product_btn_itm">
