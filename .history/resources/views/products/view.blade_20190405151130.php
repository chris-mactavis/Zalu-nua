			...
			<div class="col-md-6">
				<div class="detail_img">
	                ...
	                <div id="slider" class="ubislider left">
						...
						<li class="gal"> 
	                    		<a> 
	                    			<img class="product-v-img" src="/{{ $attribute->image }}" data-variants="{{$product->product_attributes[$iterate++]->product_attributes}}" data-variant_id="{{$product->product_attributes[$iterate]->product_attributes}}"> 
	                    		</a> 
	                    	</li>
					...
					<div class="product_btns">
						<div class="product_btn_itm">
							<form action="{{ route('cart.add') }}" method="post" style="width:100%">
								...
								<input type="hidden" name="product_variant" id="product_variant" value="1">
