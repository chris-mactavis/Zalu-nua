...
class AdminProductsController extends Controller
{
    ...
    public function create()
    {
        ...
        $product_variants = ProductAttribute::with(['options'])->get();
    ...
    public function store(Request $request)
    {
        ...
        $product_image->move('uploads/banners', $product_image_new_name);
            return $request->all();z
        $variants = [];
        foreach (ProductAttribute::get() as $attribute) {
            $variant_name = $attribute->attribute;
            $variant_option = $request->get('variant_' . $variant_name);
            $variants[] = ['variant_name' => $variant_name, 'variant_option' => $variant_option];
        }
        return $variants;
        ...
        // foreach ($request->selected_attributes as $attribute) {
        //     $product_attribute_id = ProductAttribute::find(ProductAttributeOption::find($attribute)->product_attribute_id)->id;
        //     $product->product_attributes()->create([
        //         'product_attribute_option_id' => $attribute,
    ...
    {
        $product = Product::with('product_attributes.product_attribute', 'product_attributes.product_attribute_option')->find($id);
