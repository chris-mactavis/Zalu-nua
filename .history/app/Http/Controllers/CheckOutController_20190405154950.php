...
class CheckOutController extends Controller
{
    ...
    {
        if($state_id) {
            $delivery_rate = ShippingZone::whereStateId($state_id)->first()->zone();
        } else {
            $delivery_rate = ShippingZone::whereCountryId($country_id)->first()->zone();
        }
    ...
    public function docheckout(Request $request)
    {
        ...
        if ($new_userinfo->country == 'Nigeria') {
            ...
            return $country_id = $request->country_id;
            $delivery_rate = $this->getDeliveryRate(null, $country_id);
        }
