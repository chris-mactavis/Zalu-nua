...
class CheckOutController extends Controller
{
    ...
    {
        $country = Country::whereCountryName($userinfo->country)->country_name;
        if ($country == 'Nigeria') {
            return ShippingZone::whereCityId($userinfo->lga)->first()->zone->rate;
        } else {
            return ShippingZone::whereCountryId($userinfo->country)->first()->zone->rate;
        }
    }
    ...
    public function pay($userinfo_id)
    {
        ...
        $state_id = $userinfo->state_id;
        $delivery_rate = $this->getDeliveryRate($state_id);
        return $delivery_rate = $this->shippingFee($userinfo);
