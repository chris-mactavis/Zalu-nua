...
R oute::g et('40    5',['a s   ' =>'4   05','u s e    s'=>'ErrorHandlerController@errorCode405']);

Route::get('5   00',[' a    s'=>'5   00','u s e    s'=>'ErrorHandlerController@errorC ode500']);
...
Route ::get('/account/edit', ['uses' => 'UsersController@edit',
'as' => 'user.edit']);

Route ::get('/account/orders', ['uses' => 'UsersController@orders',
'as' => 'user.orders']);

Route ::get('/account/orders/details/{id}', ['uses' => 'UsersController@order_details',
'as' => 'user.order_details']);

Route ::get('/confirm_checkout', ['uses' => 'CheckoutController@index',
'as' => 'checkout.index']);

Route ::get('/delivery', ['uses' => 'CheckoutController@delivery',
'as' => 'checkout.delivery']);

Rou te: :post('/checkout', ['uses' => 'CheckoutController@docheckout',
'as' => 'checkout.docheckout']);

Rou te: :post('/checkout/dotransfer', ['uses' => 'CheckoutController@dotransfer',
'as' => 'checkout.dotransfer']);

Route ::get('/checkout/transfer', ['uses' => 'CheckoutController@transfer',
'as' => 'checkout.transfer']);

Route ::get('/checkout/pay/{userinfo_id}', ['uses' => 'CheckoutController@pay',
'as' => 'checkout.pay']);


Rou te: :post('/checkout/pay', ['uses' => 'CheckoutController@redirectToGateway',
'as' => 'checkout.makepayment']);

Route ::get('/checkout/callback', ['uses' => 'CheckoutController@handleGatewayCallback',
'as' => 'checkout.callback']);

Route ::get('/checkout/thankyou', ['uses' => 'CheckoutController@thankyou',
