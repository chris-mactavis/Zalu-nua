...
Route: :post('/checkout', ['uses' => 'CheckoutController@docheckout',
'as' => 'checkout.docheckout']);

Route: :post('/checkout/dotransfer', ['uses' => 'CheckoutController@dotransfer',
...
Route: :post('/checkout/pay', ['uses' => 'CheckoutController@redirectToGateway',
