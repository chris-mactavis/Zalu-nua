		 ...
		 <div class="row">
		 	<div class="col-md-8 col-sm-12 col-xs-12">
		 		...
		 		<div class="row">
		 			...
		 			<div class="col-md-4">
		 				<div class="footer_itm_title">
				 			<h4 class="caps light">Support</h4>
				 		</div>
		 				<div class="footer_itm">
		 					<ul>
								<li>
									<a href="/contact">Contact Us</a>
									{{-- <a href="mailto:info@zalu-nua.com" class="contact">info@zalu-nua.com</a>
									<a href="tel:+2349065615669" class="contact">09065615669</a>
									<a href="tel:+2349068530816" class="contact">09068530816</a> --}}
								</li>
		 					</ul>
		 				</div>
		 			</div>
