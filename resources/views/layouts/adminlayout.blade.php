            ...
            <ul class="metismenu" id="side-menu">
              ...
              <li>
                ...
                <ul class="nav nav-sub nav-second-level collapse">
                  ...
                  <li><a href="/admin/product-attributes">Product Attributes</a></li>                  
                </ul>
              </li>
              ...
              <li>
                <a href="/admin/coupons">
                  <i class="fa fa-percent"></i>  <span class="menu-label">Coupons </span>
                </a>
                {{-- <ul class="nav nav-sub nav-second-level collapse">
                  <li><a href="/admin/coupons">Coupons</a></li>
                  <li><a href="/admin/coupon-types">Coupon Types</a></li>
                </ul> --}}
              </li>
              ...
              <li>
                <a href="#">
                  <i class="fa fa-truck"></i>  <span class="menu-label">Shipping Zones</span> 
                  <span class="badge badge-success badge-sm new-feature">new</span>
                  <span class="fa arrow"></span>
                </a>
                <ul class="nav nav-sub nav-second-level collapse">
                  <li><a href="/admin/shipping-zones">View</a></li>
                  <li><a href="/admin/shipping-zones/manage">Manage Shipping Zones</a></li>
                </ul>
              </li>
