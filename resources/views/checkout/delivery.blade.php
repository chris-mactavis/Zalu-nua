...
<input type="hidden" id="userinfocity" value="{{$userinfo->lga}}">
                    ...
                    <div class="checkout_sidebar">
                        ...
                        <form action="{{ route('checkout.docheckout') }}" method="post">
                            ...
                            <div class="checkout_form_itm">
                                <p class="form_label">
                                    <input type="radio" id="primary-address" name="delivery_address" checked value="default" onclick="show1();">
                                    <label for="primary-address">Primary Delivery Address</label>
                                </p>
                                <div class="form_ins">
                                    <p>{{ $userinfo->address }}</p>
                                    <p>{{ $userinfo->country == 'Nigeria' ? $userinfo->city : $userinfo->city_alt }}</p>
                                    <p>
                                        <?php
                                        if($userinfo->country == 'Nigeria'):
                                            echo $userinfo->state_id ?? $userinfo->state_alt;
                                        else:
                            ...
                            <div class="hidden_form" id="hidden_form">
                                ...
                                <div class="form-group" id="city-group" style="display: none;">
                                    ...
                                    <input id="city" type="text" class="form-control" name="city" autocomplete="off">
                                </div>
                            ...
                            <input type="hidden" name="total_fee" id="ttalfee" value="{{Cart::subtotal()}}">
                            <input type="hidden" name="shipping_fee" id="tshipfee" value="{{$delivery_rate}}">
                            <input type="hidden" name="discount_fee" id="discountfee" value="">


                            <div class="form-group">
                                <label for="coupon" class="label">Coupon Code</label>
                                <input id="coupon" type="text" class="form-control" name="coupon" placeholder="Enter Coupon Code">
                                <span id="coupon-error" class="text-danger"></span>
                            </div>
                            <div class="form-group">
                                <div>
                                    <label class="label">Add special instructions for your order.</label>
                                    <textarea name="instruction" rows="4" class="form-control" placeholder="Special instructions for your order"></textarea>
                                </div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <h5 id="total-fee">&#8358;<span>{{ $display_total }}</span></h5>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="2"><h6>Shipping Fee</h6></td>
                                    <td id="shipping-fee"><h6>₦<span>{{number_format($delivery_rate, 2)}}</span></h6></td>
                                    <input type="hidden" id="shipping-fee-previous" value="{{$delivery_rate}}">
                                </tr>
                                <tr>
                                    <td colspan="2"><h6>Discount Applied</h6></td>
                                    <td id="discount"><h6>₦<span>0</span></h6></td>
                                </tr>
