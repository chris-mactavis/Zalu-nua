...
Route::group(['prefix' => 'user', 'middleware' => 'auth'], function () {
	...
	Route::get('/checkout/transfer/{transaction_id}', [
	...
	Route::post('/checkout/ravecallback', [
		'uses' => 'CheckOutController@ravecallback',
		'as' => 'ravecallback'
	]);
...
Route::post('/coupons/verify', 'CouponsController@verify');
