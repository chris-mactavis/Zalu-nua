...
Route::group(['namespace' => 'Admin'], function () {
    ...
    Route::get( '/product-attributes', 'ProductAttributesController@index');
    Route::post( '/product-attributes', 'ProductAttributesController@store');
    Route::patch( '/product-attributes/{product_attribute}', 'ProductAttributesController@update');
    Route::delete( '/product-attributes/{product_attribute}', 'ProductAttributesController@destroy');
    ...
    Route::post('/coupons', 'AdminCouponsController@store');
    ...
    Route::delete('/coupons/{id}', 'AdminCouponsController@destroy');
    ...
    //  Shipping Zones
    Route::get('/shipping-zones', 'ShippingZonesController@index');
    Route::post('/shipping-zones', 'ShippingZonesController@store');
    Route::patch('/shipping-zones/{zone}', 'ShippingZonesController@update');
    Route::delete('/shipping-zones/{zone}', 'ShippingZonesController@destroy');
    Route::get('/shipping-zones/manage', 'ShippingZonesController@manage');
    Route::post('/add-cities-to-shipping-zones', 'ShippingZonesController@addCities');
    Route::post('/add-states-to-shipping-zones', 'ShippingZonesController@addStates');
    Route::post( '/add-countries-to-shipping-zones', 'ShippingZonesController@addCountries');
